...
private String  url ="http://www.posh24.se/kandisar";
    ...
    private void getContent(){
        DownloadContnetTask task =new DownloadContnetTask();
        try {
    ...
    private static  class DownloadContnetTask extends AsyncTask<String,Void,String>{
